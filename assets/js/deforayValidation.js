...
// function to get elements by multiple tags 
...
var deforayValidator = {
    ...
    validate: function () {
        error = '';
        this.form = document.getElementById(this.settings["formId"]);
        formInputs = $("input[type='text'],input[type='radio'],input[type='checkbox'],input[type='password'],textarea,select");
